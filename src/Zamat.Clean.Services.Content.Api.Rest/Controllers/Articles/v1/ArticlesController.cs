...
using Zamat.Clean.Services.Content.Api.Rest;
using Zamat.Clean.Services.Content.Api.Rest.Controllers;
...
namespace Zamat.Clean.Services.Content.Api.Rest.Controllers.Articles.v1;
